...
input[type=email] {
       background-image: url('{{ asset('build/assets/img/at.png') }}');
       background-repeat: no-repeat;
       background-position: 15px;
       padding: 12px 20px 12px 40px;
       border-radius: 30px;
            ...
            <div class="col-md-12 col-lg-10 mx-auto d-flex">
                <div class="col-md-7 d-none d-sm-block position-relative d-flex ">
                    <div class="position-absolute ps-3 mt-5 lh-lg top-25">
                        ...
                        <p class="text-light">Hayatın her anını organize etmek artık daha kolay ve verimli! TodoMaster, güçlü ve
                    ...
                    <img src ="{{ asset('build/assets/img/login.png') }}" class="img-fluid d-none d-md-block">
                </div>
                <div class="col-md-5 col-sm-12 d-flex flex-column justify-content-center px-5 bg-light">
                    <form method="POST" action="{{ route('register') }}">
                        @csrf
                        <h2 class="text-center pb-3 fw-bold pt-3">Kayıt Olun</h2>
                        <div class="input-group mb-3">
                            <input id="name" type="text" class="form-control shadow-none" placeholder='Adınızı Girin'
                        ...
                        <div class="input-group mb-3">
                            <input id="email" type="email" class="form-control shadow-none" placeholder='Email Adresiniz'
                        ...
                        <div class="input-group mb-3">
                            <input id="password"  type="password" class="form-control shadow-none" placeholder='Password'
                        ...
                        <div class="input-group mb-3">
                            <input  id="password-confirm" type="password" class="form-control shadow-none" placeholder='Password Tekrar'
                            name="password_confirmation" required autocomplete="new-password">
                        </div>
                        <div class="input-group mb-3 justify-content-center">
                            <button class="btn-grad fw-light" type="submit">KAYIT OLUN</button>
                        </div>
                        <div class="input-group mb-3 justify-content-center">
